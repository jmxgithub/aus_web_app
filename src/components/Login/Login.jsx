			...
			<div id="wrap">
				...
				<div className="login row">
					<div style={{width: '1200px', margin: '0 auto'}}>
						<div className="form-box col-md-16">
							<div className="xdata-img col-md-7 col-sm-12 col-xs-12">
								<img style={{ width: '100%' }} className="col-sm-12 col-xs-12" src={ require('../../assets/img/login.png') }/>
							</div>
							<div className="form-login col-md-3 col-sm-12 col-xs-12 row">
								<h3>用户登录</h3>
								...
								<a href="#" className="activation" ref="activation" data-toggle="modal" data-target="#activation" style={{float: 'right', padding: '0 10px', fontSize: '15px', display: this.state.display}} onClick={this.activation} >激活</a>
							</div>
						</div>
					</div>
				</div>
