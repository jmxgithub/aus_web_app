        ...
        if (userRolePermission.indexOf('USER_') != -1) {
            tableConfig.columnDefs = [{
                ...
                'render': function (data, type, row) {
                    ...
                    if (row.userName != 'admin' && row.userName != XDataUserName && userRolePermission.indexOf('USER_DELETE') != -1) {
