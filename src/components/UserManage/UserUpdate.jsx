...
class UserUpdate extends Component {
    ...
    userUpdateSave() {
        ...
        if (!isValidate) {
            this.props.userUpdateSave(this.props.usermanage.userDetail.result.detail);
        }else {
                ...
                <div className="row">
                    <div className="box-body col-md-12">
                        ...
                        <div className="col-md-5">
                            ...
                            <div className="form-group col-md-12">
                                <label>角色名称：</label>
                                <input className="form-control roleName" value={this.props.usermanage.userDetail.result.detail.roleName} disabled/>
                            </div>
                        </div>
