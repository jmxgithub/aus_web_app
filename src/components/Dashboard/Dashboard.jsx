...
class Dashboard extends Component {
        ...
        if (userRolePermission.indexOf('DASHBOARD_') != -1) {
            tableConfig.columnDefs = [
                ...
                'render': function (data, type, row) {
                    ...
                    if (userInfo.quickLink.indexOf(row.dashboardName) === -1 && row.owner === userName) {
    ...
    removeOKHandler() {
        ...
        if (userInfo.quickLink.indexOf(dashboardName) != -1) {
            userInfo.quickLink = userInfo.quickLink.split(dashboardName + ';')[0];
            this.props.setQuickLinkInfo(userInfo);
        }
